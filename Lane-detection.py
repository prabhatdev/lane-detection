...
##                    flag1 = False
##                    flag2 = False
##                    #print 'accute (',ax1,',',ay1,') - (',ax2,', ',ay2,')'
##                    #print 'obtuse (',ox1,',',oy1,') - (',ox2,', ',oy2,')'
##                    line1 = [(ax1,ay1),(ax2,ay2)]
##                    line2 = [(ox1,oy1),(ox2,oy2)]
##                    point = self.intersect(line1,line2)
##                    q = Queue()
##                    q.put(point)
##                    thread1 = Thread( target=self.steering_thread,args=(q,) )
##                    thread1.start()
##                    #thread1.join()
##                    print x,', ',y
##                    cv2.circle(image,(375,700),8,(255,255,255),2)
